...
* [EKA2L1](https://github.com/EKA2L1/EKA2L1) ⭐ 2,021 | 🐛 117 | 🌐 C++ | 📅 2026-09-25 - Emulates Symbian OS/N-Gage's kernel and reimplements most of its critical app servers and libraries.
...
* [Dictionaries](https://github.com/goldendict/goldendict/issues/765) ⭐ 6,676 | 🐛 616 | 🌐 C++ | 📅 2025-10-11 - A collection of open-source dictionaries for Symbian OS.
* [Whisk3D](https://github.com/Dante-Leoncini/Whisk3D) ⭐ 294 | 🐛 1 | 🌐 C++ | 📅 2026-09-24 - 2D/3D creation tool for modeling, rendering, animation, and game development.
...
* [Awesome CPP](https://github.com/fffaraz/awesome-cpp) ⭐ 73,470 | 🐛 311 | 📅 2026-09-20 - A curated list of awesome C++ (or C) frameworks, libraries, resources, and shiny things. Inspired by awesome-... stuff.
* [Awesome J2ME](https://github.com/hstsethi/awesome-j2me) ⭐ 424 | 🐛 1 | 🌐 Java | 📅 2026-07-28 - An awesome list about Java Platform Micro Edition (J2ME), a Java specification for small computing devices.
* [Symbian Archive](https://github.com/mrRosset/Symbian-Archive) ⭐ 188 | 🐛 36 | 🌐 CSS | 📅 2019-12-05 - Archive and website for Symbian-related downloads.
...
* [E32Explorer](https://github.com/mrRosset/E32Explorer) ⭐ 13 | 🐛 1 | 🌐 C++ | 📅 2020-11-05 - A tool that visualizes different parts of a Symbian OS E32Image, including preliminary support for the TRomImage format.
* [RomBrowser](https://github.com/Florin9doi/rombrowser) ⭐ 6 | 🐛 0 | 🌐 C++ | 📅 2021-04-22 - A utility for visualizing ROM dump contents. ROM images can be produced using [romdump](https://github.com/Florin9doi/romdump) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2021-04-20 or [SDumper](https://github.com/Florin9doi/sdumper) <sup>(dead)</sup>.
